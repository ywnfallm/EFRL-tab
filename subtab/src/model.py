...
class SubTab:
    ...
    def fit(self, data_loader):
        ...
        save_loss_plot(self.loss, self._plots_path, self.options["datafile_name"])
        ...
        #loss_df.to_csv(self._loss_path + "/" + self.options["datafile_name"] +"_losses.csv")
    ...
    def save_weights(self):
        ...
        for model_name in self.model_dict:
            th.save(self.model_dict[model_name], self._model_path + "/" + self.options["datafile_name"]+"_"+model_name + ".pt")
        print("Done with saving models.")

    def load_models(self):
        """Used to load weights saved at the end of the training."""
        for model_name in self.model_dict:
            model = th.load(self._model_path + "/" + self.options["datafile_name"]+"_"+model_name + ".pt", map_location=self.device)
